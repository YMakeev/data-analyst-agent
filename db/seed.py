"""Генератор синтетичних даних для навчальної бази.
...
Часові рамки рахуються відносно --as-of (за замовчуванням — сьогодні), тож
дані завжди виглядають свіжими, коли б скрипт не запустили.

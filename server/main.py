...
Тут майже немає логіки — тільки реєстрація інструментів і вибір способу
зв'язку з клієнтом.

Зверни увагу на функцію main(): різниця між «працює в мене на комп'ютері» і
«працює у всієї команди» — це кілька рядків саме тут. Код інструментів
однаковий в обох випадках.

Локально Claude Desktop сам запускає цей процес і спілкується з ним через
стандартні потоки введення й виведення. У хмарі той самий сервер слухає
мережевий порт, і до нього під'єднуються за посиланням.
"""
